...
public class AlquilerControlador {
	...
	public ResponseEntity<Alquiler> consultarItem(@PathVariable String id) {

		Long idA = Long.valueOf(id);
		Alquiler respuesta = alquilerServicio.consultar(idA);
	...
	public ResponseEntity<List<Alquiler>> consultarItems() {

		List<Alquiler> resultado = alquilerServicio.consultarAlquileres();
